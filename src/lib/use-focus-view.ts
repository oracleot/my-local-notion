...
import {
  ...
  findAvailableHour, getRemainingCapacity, type EligibleCard,
...
export function useFocusView() {
  ...
  return {
    ...
    pendingCard, pendingRescheduleBlock, settingsOpen, setSettingsOpen, settings, setSettings, activeSession,
    scheduledCount, totalMinutes, durationPickerOpen, setDurationPickerOpen, pendingDuration,
    handleSlotClick, handleStartBlock, handleSchedule, handleScheduleWithTimePicker, handleTimeSlotSelected,
    handleDurationSelected, handleScheduleFromSidebar: handleScheduleWithTimePicker, handleRescheduleBlock,
    handleMoveBlock, navigateDay, navigateWeek, handleDayClickFromWeek, goToToday,
  };
}
